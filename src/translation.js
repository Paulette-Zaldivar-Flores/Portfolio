function updateLanguage(language) {
  ...
  if (language === "spanish") {
    ...
    health.textContent = "Una aplicación móvil que te permite cargar, traducir y compartir documentos médicos. Este proyecto fue desarrollado para mi proyecto final en Le Wagon Tokyo. Fui el desarrollador frontend, el gerente de proyecto y el diseñador para este proyecto. Sin embargo, también participé como desarrollador fullstack para varias funciones. ¡Echa un vistazo a la demo!";
    ...
    cocktails.textContent = "Ez Cocktails es un sitio web donde puedes buscar tus recetas favoritas de cócteles. Este es mi primer proyecto grupal desarrollado para el Voyage 40 en Chingu. En este proyecto, fui el desarrollador y diseñador frontend. Aprendí a usar Jira y Git durante el desarrollo de este proyecto.";
    ...
    babyloop.textContent = "Una aplicación web de comercio electrónico que te permite alquilar y alquilar productos para bebés al cargar tus ofertas. Este proyecto fue desarrollado para Le Wagon Tokyo y es mi primer proyecto fullstack. Fui el desarrollador frontend, diseñador y gestor de proyecto.";
    ...
    health.textContent = "A mobile application that allows you upload, translate and share medical documents. This projects was developed for my final project assignment for Le Wagon Tokyo. I was the frontend developer,project manager and designer for this project. However, I participated as a fullstack developer for several features. Check out the demo."
    ...
    cocktails.textContent = "Ez Cocktails is a website where you can search your favorite cocktail recipes. This is my first group project developed for Voyage 40 at Chingu. For this project I was the frontend developer and designer. I learned how to use Jira and Git during the development of this project."
    ...
    babyloop.textContent = "An ecommerce app web that allows you to rent and rent out baby products by uploading your offers. This project was developed for Le Wagon Tokyo and is my first fullstack project. I was the frontend developer, designer and project manager for this project."
