function updateLanguage(language) {
  ...
  if (language === "spanish") {
    ...
    health.textContent = "A mobile application that allows you upload, translate and share medical documents. This was developed as my final project for Le Wagon Tokyo. I was the lead frontend developer, project manager and designer. However, I participated as a fullstack developer for several features. Check out the demo."
